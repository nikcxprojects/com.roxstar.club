...
class ImageViewScrolling10 : FrameLayout {
    internal  lateinit var eventEnd1: IEventEnd10
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd1: IEventEnd10){
