package com.roxstar.club.imageViewScrolling2
...
import kotlinx.android.synthetic.main.image_view_scrolling2.view.currentImage
import kotlinx.android.synthetic.main.image_view_scrolling2.view.nextImage
import kotlinx.android.synthetic.main.image_view_scrolling9.view.*

class ImageViewScrolling2 : FrameLayout {
    internal  lateinit var eventEnd1: IEventEnd2
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd1: IEventEnd2){
