package com.roxstar.club.imageViewScrolling1_0
...
import kotlinx.android.synthetic.main.image_view_scrolling1_0.view.*
import kotlinx.android.synthetic.main.image_view_scrolling1_0.view.currentImage
import kotlinx.android.synthetic.main.image_view_scrolling1_0.view.nextImage
import kotlinx.android.synthetic.main.image_view_scrolling1_4.view.*

class ImageViewScrolling1_0 : FrameLayout {
    internal  lateinit var eventEnd11: IEventEnd1_0
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd11: IEventEnd1_0){
    ...
    private fun init(context: Context){
        LayoutInflater.from(context).inflate(R.layout.image_view_scrolling1_0,this)
