package com.roxstar.club.imageViewScrolling9
...
class ImageViewScrolling9 : FrameLayout {
    internal  lateinit var eventEnd1: IEventEnd9
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd1: IEventEnd9){
    ...
    private fun init(context: Context){
        LayoutInflater.from(context).inflate(R.layout.image_view_scrolling9,this)
