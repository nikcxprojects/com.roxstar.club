package com.roxstar.club.imageViewScrolling6
...
import kotlinx.android.synthetic.main.image_view_scrolling6.view.*
import kotlinx.android.synthetic.main.image_view_scrolling6.view.currentImage
import kotlinx.android.synthetic.main.image_view_scrolling6.view.nextImage
import kotlinx.android.synthetic.main.image_view_scrolling9.view.*

class ImageViewScrolling6 : FrameLayout {
    internal  lateinit var eventEnd1: IEventEnd6
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd1: IEventEnd6){
    ...
    private fun init(context: Context){
        LayoutInflater.from(context).inflate(R.layout.image_view_scrolling6,this)
