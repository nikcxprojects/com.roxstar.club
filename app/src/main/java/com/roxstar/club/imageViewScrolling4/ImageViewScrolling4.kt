package com.roxstar.club.imageViewScrolling4
...
import kotlinx.android.synthetic.main.image_view_scrolling4.view.*
import kotlinx.android.synthetic.main.image_view_scrolling4.view.currentImage
import kotlinx.android.synthetic.main.image_view_scrolling4.view.nextImage
import kotlinx.android.synthetic.main.image_view_scrolling9.view.*

class ImageViewScrolling4 : FrameLayout {
    internal  lateinit var eventEnd1: IEventEnd4
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd1: IEventEnd4){
    ...
    private fun init(context: Context){
        LayoutInflater.from(context).inflate(R.layout.image_view_scrolling4,this)
