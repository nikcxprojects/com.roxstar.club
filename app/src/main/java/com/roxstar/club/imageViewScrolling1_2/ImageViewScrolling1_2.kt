package com.roxstar.club.imageViewScrolling1_2
...
import kotlinx.android.synthetic.main.image_view_scrolling1_2.view.*
import kotlinx.android.synthetic.main.image_view_scrolling1_2.view.currentImage
import kotlinx.android.synthetic.main.image_view_scrolling1_2.view.nextImage
import kotlinx.android.synthetic.main.image_view_scrolling9.view.*

class ImageViewScrolling1_2 : FrameLayout {
    internal  lateinit var eventEnd11: IEventEnd1_2
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd11: IEventEnd1_2){
    ...
    private fun init(context: Context){
        LayoutInflater.from(context).inflate(R.layout.image_view_scrolling1_2,this)
