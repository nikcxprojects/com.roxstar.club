package com.roxstar.club.imageViewScrolling8
...
import kotlinx.android.synthetic.main.image_view_scrolling8.view.*
import kotlinx.android.synthetic.main.image_view_scrolling8.view.currentImage
import kotlinx.android.synthetic.main.image_view_scrolling8.view.nextImage
import kotlinx.android.synthetic.main.image_view_scrolling9.view.*

class ImageViewScrolling8 : FrameLayout {
    internal  lateinit var eventEnd1: IEventEnd8
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd1: IEventEnd8){
    ...
    private fun init(context: Context){
        LayoutInflater.from(context).inflate(R.layout.image_view_scrolling8,this)
