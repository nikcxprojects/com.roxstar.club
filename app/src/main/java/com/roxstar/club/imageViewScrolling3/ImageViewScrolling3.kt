package com.roxstar.club.imageViewScrolling3
...
import kotlinx.android.synthetic.main.image_view_scrolling3.view.currentImage
import kotlinx.android.synthetic.main.image_view_scrolling3.view.nextImage
import kotlinx.android.synthetic.main.image_view_scrolling9.view.*

class ImageViewScrolling3 : FrameLayout {
    internal  lateinit var eventEnd1: IEventEnd3
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd1: IEventEnd3){
