package com.roxstar.club.imageViewScrolling5
...
import kotlinx.android.synthetic.main.image_view_scrolling5.view.*
import kotlinx.android.synthetic.main.image_view_scrolling5.view.currentImage
import kotlinx.android.synthetic.main.image_view_scrolling5.view.nextImage
import kotlinx.android.synthetic.main.image_view_scrolling9.view.*

class ImageViewScrolling5 : FrameLayout {
    internal  lateinit var eventEnd1: IEventEnd5
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd1: IEventEnd5){
    ...
    private fun init(context: Context){
        LayoutInflater.from(context).inflate(R.layout.image_view_scrolling5,this)
