...
import com.roxstar.club.imageViewScrolling10.IEventEnd10
import com.roxstar.club.imageViewScrolling2.IEventEnd2
import com.roxstar.club.imageViewScrolling3.IEventEnd3
import com.roxstar.club.imageViewScrolling4.IEventEnd4
import com.roxstar.club.imageViewScrolling5.IEventEnd5
import com.roxstar.club.imageViewScrolling6.IEventEnd6
import com.roxstar.club.imageViewScrolling7.IEventEnd7
import com.roxstar.club.imageViewScrolling8.IEventEnd8
import com.roxstar.club.imageViewScrolling9.IEventEnd9
import kotlinx.android.synthetic.main.activity_slot_games2.*
import kotlin.random.Random

class SlotGamesActivity2 : AppCompatActivity(), IEventEnd2, IEventEnd3, IEventEnd4, IEventEnd5,
    IEventEnd6, IEventEnd7, IEventEnd8, IEventEnd9, IEventEnd10 {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_slot_games2)

        hideSystemBars()

        textView7.text = credit.toString()

        slots1.setEventEnd(this@SlotGamesActivity2)
        slots2.setEventEnd(this@SlotGamesActivity2)
        slots3.setEventEnd(this@SlotGamesActivity2)
        slots4.setEventEnd(this@SlotGamesActivity2)
        slots5.setEventEnd(this@SlotGamesActivity2)

        slots6.setEventEnd(this@SlotGamesActivity2)
        slots7.setEventEnd(this@SlotGamesActivity2)
        slots8.setEventEnd(this@SlotGamesActivity2)
        slots9.setEventEnd(this@SlotGamesActivity2)
        slots10.setEventEnd(this@SlotGamesActivity2)

        slots11.setEventEnd(this@SlotGamesActivity2)
        slots12.setEventEnd(this@SlotGamesActivity2)
        slots13.setEventEnd(this@SlotGamesActivity2)
        slots14.setEventEnd(this@SlotGamesActivity2)
        slots15.setEventEnd(this@SlotGamesActivity2)
