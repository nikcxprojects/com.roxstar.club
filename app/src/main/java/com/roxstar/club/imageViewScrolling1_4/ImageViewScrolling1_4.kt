package  com.roxstar.club.imageViewScrolling1_4
...
import kotlinx.android.synthetic.main.image_view_scrolling1_4.view.currentImage
import kotlinx.android.synthetic.main.image_view_scrolling1_4.view.nextImage
import kotlinx.android.synthetic.main.image_view_scrolling9.view.*

class ImageViewScrolling1_4 : FrameLayout {
    internal  lateinit var eventEnd11: IEventEnd1_4
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd11: IEventEnd1_4){
    ...
    private fun init(context: Context){
        LayoutInflater.from(context).inflate(R.layout.image_view_scrolling1_4,this)
