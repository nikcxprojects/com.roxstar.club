package com.roxstar.club.imageViewScrolling1_3
...
import kotlinx.android.synthetic.main.image_view_scrolling1_3.view.*
import kotlinx.android.synthetic.main.image_view_scrolling1_3.view.currentImage
import kotlinx.android.synthetic.main.image_view_scrolling1_3.view.nextImage
import kotlinx.android.synthetic.main.image_view_scrolling9.view.*

class ImageViewScrolling1_3 : FrameLayout {
    internal  lateinit var eventEnd11: IEventEnd1_3
...
//        get() = Integer.parseInt(nextImage.tag.toString())
    ...
    fun setEventEnd(eventEnd11: IEventEnd1_3){
    ...
    private fun init(context: Context){
        LayoutInflater.from(context).inflate(R.layout.image_view_scrolling1_3,this)
